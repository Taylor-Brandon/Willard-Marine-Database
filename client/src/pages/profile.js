                ...
                <div id='profileShip-card' className='card'> 
                    ...
                    <div className='card-body'>
                        ...
                        <h5>Access and manage ship data</h5>
                            <a className="btn btn-primary" data-bs-toggle="collapse" href="#multiCollapseExample2" role="button" aria-expanded="false" aria-controls="multiCollapseExample2">
                            <i className="bi bi-arrow-down"></i>
                            </a>
                        </div>
                        <div className="row">
                ...
                <div id='profilePdf-card' className='card'> 
                    ...
                    <div className='card-body'>
                        ...
                        <h5>Access and manage PDF file data</h5>
                            <a className="btn btn-primary" data-bs-toggle="collapse" href="#multiCollapseExample3" role="button" aria-expanded="false" aria-controls="multiCollapseExample3">
                            <i className="bi bi-arrow-down"></i>
                            </a>
                        </div>
                        <div className="row">
